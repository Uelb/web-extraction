...
SSQL.getWeightVector = function(weights) {
  ...
  result = [weights.color, weights.bgColor, weights.width, weights.height, weights.textDecoration, weights.fontStyle, weights.leftAlignment, weights.topAlignement, weights.zIndex, weights.paddingLR, weights.paddingTB, weights.borderWidth];
...
SSQL.getVector = function(element) {
  var bgColor, borderWidth, color, fontStyle, height, leftAlignment, paddingLR, paddingTB, textDecoration, topAlignement, width, zIndex;
  ...
  return [color, bgColor, width, height, textDecoration, fontStyle, leftAlignment, topAlignement, zIndex, paddingLR, paddingTB, borderWidth];
};
