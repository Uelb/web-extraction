...
SSQL.processData = function(data){
  ...
  console.log("Agglomerating");
  var root = figue.agglomerate(labels, vectors, SSQL.CUSTOM_DISTANCE, figue.COMPLETE_LINKAGE);
  // console.log(root.buildDendogram (3, true, true, false, false));
};
